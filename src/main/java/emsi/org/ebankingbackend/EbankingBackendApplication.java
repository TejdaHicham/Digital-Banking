package emsi.org.ebankingbackend;

import emsi.org.ebankingbackend.dtos.BankAccountDTO;
...
import emsi.org.ebankingbackend.services.BankService;
...
public class EbankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        ...
        return args -> {
            ...
            Stream.of("Hicham","Omar","Mohammed").forEach(name->{
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            Stream.of("Ikram","Saad","Zaki").forEach(name->{
